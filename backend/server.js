    ...
    try {
        const response = await axios.post(
            ...
            new URLSearchParams({
                ...
                hash: process.env.GETCONTACT_HASH, // Your unique GetContact hash
            ...
            }),
            {
                headers: {
                    ...
                    Cookie: process.env.GETCONTACT_COOKIE, // GetContact session cookies
                },
            }
        );
        ...
        console.error("❌ Error fetching data from GetContact:", error.message);
        res.status(500).json({ error: "Failed to fetch data from GetContact" });
    }
});
